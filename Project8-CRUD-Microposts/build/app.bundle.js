...
function submitPost() {
  ...
  var data = {
    ...
    if (id === '') {
      ...
      // Update post
      http.put('http://localhost:3000/posts/' + id, data).then(function (data) {
...
function deletePost(e) {
  if (e.target.parentElement.classList.contains('delete')) {
    ...
    if (confirm('Are you sure you want to delete this post?')) {
      http.delete('http://localhost:3000/posts/' + id).then(function (data) {
